/**
 * Span-kind colour palette. Shared by the trace detail waterfall and the
 * spans list so a kind dot in one matches the bar colour in the other. Uses
 * the dashboard's semantic CSS variables so colours adapt across light and
...
/** Resolve the colour for a span: blocked overrides; otherwise look up kind. */
