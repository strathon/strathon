"""Add CEL policy evaluation tables and indexes

Adds the policies table for runtime intervention rules and the
policy_matches audit table that records every match outcome.
...
_DOWNGRADE_SQL = r"""
DROP TABLE IF EXISTS policy_matches CASCADE;
