"""OpenAI instrumentation for Strathon."""
...
def instrument(client) -> bool:
    """
    Instrument OpenAI for trace capture.
    ...
    # TODO: monkey-patch OpenAI APIs to emit Strathon spans
    ...
    logger.info("OpenAI instrumentation registered (stub)")
    return True
